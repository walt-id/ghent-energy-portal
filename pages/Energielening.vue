...
<div class="max-w-2xl px-8 mx-auto">
  <div class="bg-white bg-opacity-90 py-8 px-4 rounded">
    <ul class="flex flex-col max-w-lg mx-auto py-8">
      <li
        class="flex space-x-4 my-2 shadow px-4 py-4 hover:bg-gray-100 hover:text-gray-700 bg-white text-gray-600 rounded"
      >
        <div class="text-4xl font-bold text-gray-500">1</div>
        <div>
          ...
          <div class="flex space-x-2 ml-auto justify-end">
            <a target="_blank" href="https://play.google.com/store/apps/details?id=com.validatedid.wallet">
              <img src="../assets/img/appstore.png" class="h-8"/>
            </a>
            <a target="_blank" href="https://apps.apple.com/es/app/vidwallet/id1554340592">
              <img src="../assets/img/appstore-ios.png" class="h-8" target="_blank"/>
            </a>
          </div>
        </div>
      </li>
      <li class="flex space-x-4 my-2 shadow px-4 py-4 hover:bg-gray-100 hover:text-gray-700 bg-white text-gray-600 rounded">
        ...
        <div>
          ...
          <a
            ...
            class="my-2 rounded px-4 py-2 hover:text-gray-700 bg-gray-300 text-gray-600 rounded"
            target="_blank"
            >Request</a
          >
        </div>
      ...
      >
        ...
        <div>
          <h2 class="text-lg font-semibold mb-2">Request your ____ at KBC</h2>
          <p class="mb-4">
            ___ facilitates your access to your verifiable credentials. You
            can authenticate with your VerifiableID.
          </p>
